...
//		    try {
//		    	
//				dlf = DLFileEntryLocalServiceUtil.addFileEntry(realUserId, groupId, groupId, 0, submissionFileName, contentType, title, description, changeLog, 0, fieldsMap, submissionFile, fis, size, serviceContext);
//				long feID = dlf.getFileEntryId();
//				DLFileEntryLocalServiceUtil.updateFileEntry(realUserId, feID, submissionFileName, contentType, title, description, changeLog, false, 0, fieldsMap, submissionFile, fis, size, serviceContext);
//				
...
//			UserGroup  userGrp = UserGroupLocalServiceUtil.addUserGroup(userId, companyId, name, description, serviceContext);
